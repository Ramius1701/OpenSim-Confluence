...
*(The WhiteCore-Dev WebUI parity audit and the avatar-selection
starter-look carousel both finished and shipped - see `FEATURES.md`'s
Web & Admin UI section rather than here.)*
