...
namespace OpenSim.Region.CoreModules.ServiceConnectorsOut.AbuseReports
{
    ...
    public class LocalAbuseReportsServicesConnector : ISharedRegionModule, IAbuseReportsService
    {
        ...
        public List<AbuseReportData> GetAbuseReports(int start, int count)
        {
            ...
            return m_service.GetAbuseReports(start, count);
        }
        ...
        public AbuseReportData GetAbuseReport(int reportID)
        {
            if (!m_Enabled)
                return null;
            return m_service.GetAbuseReport(reportID);
        }
        ...
        public bool UpdateAbuseReport(AbuseReportData report)
        {
            if (!m_Enabled)
                return false;
            return m_service.UpdateAbuseReport(report);
        }
        ...
        public bool DeleteAbuseReport(int reportID)
        {
            if (!m_Enabled)
                return false;
            return m_service.DeleteAbuseReport(reportID);
        }
